...
export type TreasureType = 'common' | 'rare' | 'epic';
        ...
        <div style={{ display: 'flex',   gap: '30px',}}>
          ...
          {Array(gridSize + 1).fill(0).flatMap((_, i) => ([
            ...
            <div style={{display: 'flex', transform: `translate(${treasureX * cellSize + cellSize/3 - 9}px, ${treasureY * cellSize + cellSize/3 - 9}px)`}}>
                ...
                {treasureType === 'epic' && (
                    <svg id="Epic" enable-background="new 0 0 512 512" height="30" viewBox="0 0 512 512" width="30" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* <div style={{display: 'flex', transform: `translate(112px, 142px)`, zIndex: 1001}}>
            <svg fill="#000000" width="30px" height="30px" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
                <path d="M152,84a36,36,0,1,0-36-36A36.04061,36.04061,0,0,0,152,84Zm0-48a12,12,0,1,1-12,12A12.01312,12.01312,0,0,1,152,36Zm64,112a12.00028,12.00028,0,0,1-12,12c-37.20215,0-55.50781-19.66406-70.21729-35.46484-.45459-.48828-.89794-.96192-1.34667-1.44239l-8.02393,18.45484,34.5625,24.68774A11.999,11.999,0,0,1,164,176v56a12,12,0,0,1-24,0V182.17578l-25.37207-18.12353L83.00488,236.78516a12.00021,12.00021,0,0,1-22.00976-9.57032l37.55322-86.37255.02881-.06592,13.74463-31.61377c-8.09571-.96167-18.24219,2.0072-30.35889,8.94482a159.5463,159.5463,0,0,0-29.47754,22.37793,12.0001,12.0001,0,0,1-16.9707-16.9707A183.31075,183.31075,0,0,1,70.03711,97.28027c36.06689-20.65234,58.03027-11.69433,70.104-.54589,3.93116,3.63085,7.63037,7.60449,11.208,11.44726C164.667,122.4873,177.24561,136,204,136A12.00028,12.00028,0,0,1,216,148Z"/>
            </svg>
            </div> */}
         </svg>
        </div>
